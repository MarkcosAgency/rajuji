...
function createClientCard(client) {
  return `
            <div class="col-lg-3 col-md-4 col-sm-6 mb-3 d-flex justify-content-center align-items-center">
                <div class="client-card">
                    <img src="${client.photo}" class="card-img-top img-fluid" alt="${client.name}">
                </div>
            </div>
        `;
}
